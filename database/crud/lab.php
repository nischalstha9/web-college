...
mysqli_query($conn, "UPDATE customer SET city='Lalitpur' WHERE city='Kathmandu'");

mysqli_query($conn, "UPDATE customer SET city='New York', country='USA' WHERE city='Shanghai' AND country='China'");

mysqli_query($conn, "DELETE FROM customer WHERE country='Australia'");

mysqli_query($conn, "SELECT * FROM customer WHERE country in ('Nepal','India')");
